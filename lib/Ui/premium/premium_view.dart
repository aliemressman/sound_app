  ...
  ElevatedButton _continueButton() {
    return ElevatedButton(
      ...
      child: const Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Text(PremiumString.continueText),
          SizedBox(width: 10),
